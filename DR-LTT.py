...
obj_2 = LinExpr(0)
for od_pair in path_dict:
    obj_2 += (1 - od_pair_reachability[od_pair[0], od_pair[1]]) * demands.loc[od_pair]

m.setObjective(obj_2, GRB.MINIMIZE)
...
print()
print('The number of reachable passengers: ' + str(demands.sum().sum() - int(obj_2.getValue())))
print()
